...
**Proceeding automatically to integration patterns analysis...**
...
Auto-advance to `./step-03-integration-patterns.md` to analyze APIs, communication protocols, and system interoperability for {{research_topic}}.
