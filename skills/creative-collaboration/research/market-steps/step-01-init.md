...
**Scope confirmed — proceeding automatically to customer insights analysis...**

### 5. Auto-Advance

- Update frontmatter: `stepsCompleted: [1]`
- Add confirmation note to document: "Scope confirmed on {{date}}"
- Immediately load: `./step-02-customer-behavior.md`
