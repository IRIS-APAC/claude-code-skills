...
- ⚠️ Auto-advance to next step after content is written to document
...
**Proceeding automatically to customer decision processes analysis...**
...
- Immediately load: `./step-04-customer-decisions.md`
