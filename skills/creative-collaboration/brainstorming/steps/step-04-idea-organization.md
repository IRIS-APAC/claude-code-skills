...
Use the `AskUserQuestion` tool to confirm completion:

- **Question:** "Ready to complete your session documentation?"
- **Header:** "Complete"
- **Options:**
  - **Complete** — Generate final brainstorming session document
  - **Continue editing** — Keep refining the action plans and priorities
