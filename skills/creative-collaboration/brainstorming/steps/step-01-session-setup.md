...
Use the `AskUserQuestion` tool to present the technique approach selection:

- **Question:** "Ready to explore technique approaches? Which approach appeals to you most?"
- **Header:** "Approach"
- **Options:**
  - **User-Selected Techniques** — Browse our complete technique library
  - **AI-Recommended Techniques** — Get customized suggestions based on your goals
...
- **If User-Selected Techniques:** Load `./step-02a-user-selected.md`
- **If AI-Recommended Techniques:** Load `./step-02b-ai-recommended.md`
- **If Random Technique Selection:** Load `./step-02c-random-selection.md`
- **If Progressive Technique Flow:** Load `./step-02d-progressive-flow.md`
