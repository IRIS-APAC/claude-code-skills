...
- `template_path` = `../references/brainstorming-template.md`
- `brain_techniques_path` = `../references/brain-methods.csv`
- `default_output_file` = `{output_folder}/brainstorming/brainstorming-session-{{date}}.md`
- `context_file` = Optional context file path from workflow invocation for project-specific guidance
- `advancedElicitationWorkflow` = `../advanced-elicitation/workflow.md`
...
- **Advanced Elicitation**: Can be invoked during brainstorming for deeper requirement exploration via `../advanced-elicitation/workflow.md`
- **Party Mode**: Can be combined with party mode for multi-agent brainstorming perspectives
